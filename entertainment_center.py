# call phyton code fresh_tomatoes for browser css format
# and opening movie trailer
# call media for class Movie
import fresh_tomatoes
import media

# creat Movie object
sword_rain = media.Movie(
    "Reign of Assassins",
    "A tells of a legendary monk that his mummified remains has mystical powers.",
    "https://upload.wikimedia.org/wikipedia/en/6/64/Reign-of-Assassins.jpg",
    "https://www.youtube.com/watch?v=IczLF2rcs10"
    )

tais_toi = media.Movie(
    "Ruby and Quentin",
...
my_neighbor_totoro = media.Movie(
    "My neighbor Totoro",
    "The adventure of 2 little girls after their family moved into an old country house.",
...
# movie lists for fresh_tomatoes to read
movies = [
